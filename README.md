...
### 2. GAS 기반 어빌리티 시스템 | GAS-Based Ability System
...
### 3. 렌더링 최적화 | Rendering Optimization
...
### 5. 진영 & 협력-배신 시스템 | Faction & Betrayal System
...
### 6. TPS 카메라 & 긴장감 설계 | TPS Camera & Tension Design
...
| 3 | ASC / AttributeSet, 소서리스 어빌리티, GE 데미지, 기초 몬스터 AI |
